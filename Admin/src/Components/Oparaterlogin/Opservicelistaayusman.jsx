...
const Opservicelistaayusman = () => {
  ...
  const voterapprove = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/approve_ayushman_address`, userdata ,options)
      .then((res) => {
    ...
    <div>
      ...
      <section className="content">
        ...
        <div className="panel panel-default">
          <div className="panel-heading">SERVICES LIST AYSUMAN ADDRESS</div>
                ...
                <table className="table">
                  <thead>
                    <tr>
                      <th>S.No.</th>
                      <th>Aadhaar Image</th>
                      <th>Aadhar Linked Phone Number</th>
                      <th>Aadhar Number</th>
                      <th>Approve</th>
                  ...
                  <tbody>
                    {accessdata?.ayushmanaddress?.map((list, index) => {
                      return (
                        <tr>
                          <td>{index + 1}</td>
                          <td>
...
export default Opservicelistaayusman;
