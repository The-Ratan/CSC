...
const Opservicelistpancardcorrection = () => {
  ...
  const voterapprove = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/approve_pancard_correction`, userdata ,options)
      .then((res) => {
    ...
    <div>
      ...
      <section className="content">
        <div className="page-heading">
          <h1 style={{ opacity: "0" }}>Services Lista</h1>
        ...
        <div className="panel panel-default">
          <div className="panel-heading">SERVICES LIST PAN CARD CORRECTION</div>
            ...
            <div className="table-responsive">
              {accessdata?.votercard?.length > 0 ? (
                <table className="table">
                  ...
                  <tbody>
                    {accessdata?.pancardcorrection?.map((list, index) => {
                      return (
                        <tr>
                          <td>{index + 1}</td>
                          <td>
...
export default Opservicelistpancardcorrection;
