...
const Opservicelistincome = () => {
  ...
  const voterapprove = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/approve_income_certificate`, userdata .opacity)
      .then((res) => {
    ...
    <div>
      ...
      <section className="content">
        ...
        <div className="panel panel-default">
          <div className="panel-heading">SERVICES LIST INCOME</div>
            ...
            <div className="table-responsive">
              {accessdata?.votercard?.length > 0 ? (
                <table className="table">
                  ...
                  <tbody>
                    {accessdata?.income?.map((list, index) => {
                      return (
                        <tr>
                          <td>{index + 1}</td>
                          <td>
                          ...
                          <td>
                            <button
                              onClick={() => {
                                secureLocalStorage.setItem("opincome", list?._id);
                                Navigate("/opincomedetails");
                              }}
                              type="button"
...
export default Opservicelistincome;
