...
const Oprenewal = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("oprenewal");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/single_renewel_passport_data`,
        userdata , options
      )
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/renewel_passport_document`,
        formdata,
        options
      )
      .then((response) => {
        ...
        <div className="sf-provi-qform">
          <form style={{ marginLeft: "20px" }}>
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="form-group">
                  <label>10th Marksheet Image</label>{" "}
                  <a
                    onClick={() =>
                      downloadImage(
              ...
              <div className="col-md-4">
                <div className="form-group">
                  <label>Old Passport or Fir Image</label>{" "}
                  <a
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/` +
