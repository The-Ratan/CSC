...
const Opservicelistdomicile = () => {
  ...
  const voterapprove = (item) => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/approve_domicile_certificate`,
        userdata ,options
      )
      .then((res) => {
    ...
    <div>
      ...
      <section className="content">
        ...
        <div className="panel panel-default">
          <div className="panel-heading">SERVICES LIST DOMICILE</div>
            ...
            <div className="table-responsive">
              {accessdata?.votercard?.length > 0 ? (
                <table className="table">
                  ...
                  <tbody>
                    {accessdata?.domicile?.map((list, index) => {
                      return (
                        <tr>
                          <td>{index + 1}</td>
                          <td>
                          ...
                          <td>
                            <button
                              onClick={() => {
                                secureLocalStorage.setItem("opdomicile", list?._id);
                                Navigate("/opdomicile");
                              }}
                              type="button"
...
export default Opservicelistdomicile;
