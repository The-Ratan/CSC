...
const Opcast = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("opcast");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/single_cast_certificate_data`,
        userdata ,options
      )
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/cast_document`, formdata, options)
      .then((response) => {
