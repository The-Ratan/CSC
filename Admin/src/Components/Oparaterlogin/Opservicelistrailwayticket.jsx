...
const Opservicelistrailwayticket = () => {
  ...
  const voterapprove = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/approve_railway_ticket`, userdata ,options)
      .then((res) => {
    ...
    <div>
      ...
      <section className="content">
        ...
        <div className="panel panel-default">
          <div className="panel-heading">SERVICES RAILWAY TICKET</div>
              ...
              {accessdata?.votercard?.length > 0 ? (
                <table className="table">
                  <thead>
                    <tr>
                      <th>S.No.</th>
                      <th>Irctc Train Status Image</th>
                      <th>Phone No.</th>
                  ...
                  <tbody>
                    {accessdata?.railwayticket?.map((list, index) => {
                      return (
                        <tr>
                          <td>{index + 1}</td>
                          <td>
...
export default Opservicelistrailwayticket;
