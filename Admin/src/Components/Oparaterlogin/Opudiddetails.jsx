...
const Opudiddetails = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("opudid");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/get_single_udidcard_data`, userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/udidcard_document`, formdata, options)
      .then((response) => {
