...
const Opupration = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("opupration");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/single_up_rationcard_data`, userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/up_rationcard_document`,
        formdata,
        options
      )
      .then((response) => {
