...
const Opayushmandetails = () => {
  const [pancard, setaccessdata] = useState();
 
  let accessdatadid = secureLocalStorage.getItem("opayushman");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/get_single_ayushmancard_data`, userdata ,options)
      .then((res) => {
...
const senddata = () => {
  ...
  axios
    .post(
      `${apiurl[0].apiUrl}subadmin/ayushman_address_document`,
      formdata,
      options
    )
    .then((response) => {
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <p
                    ...
                    className="form-control"
                  >{pancard?.aadhar_linked_phone_no}</p>
                </div>
              </div>
...
export default Opayushmandetails;
