...
const Opservicelistlostreport = () => {
  ...
  const voterapprove = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/approve_lostreport`, userdata ,options)
      .then((res) => {
    ...
    <div>
      ...
      <section className="content">
        ...
        <div className="panel panel-default">
          <div className="panel-heading">SERVICES LIST LOST REPORT</div>
            ...
            <div className="table-responsive">
              {accessdata?.votercard?.length > 0 ? (
                <table className="table">
                  ...
                  <tbody>
                    {accessdata?.lostreport?.map((list, index) => {
                      return (
                        <tr>
                          <td>{index + 1}</td>
                          <td>
                          ...
                          <td>
                            <button
                              onClick={() => {
                                secureLocalStorage.setItem("oplostreport", list?._id);
                                Navigate("/oplostreport");
                              }}
                              type="button"
...
export default Opservicelistlostreport;
