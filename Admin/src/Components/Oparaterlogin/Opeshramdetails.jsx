...
const Opeshramdetails = () => {
  const [pancard, setaccessdata] = useState();

  let accessdatadid = secureLocalStorage.getItem("opeshram");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/get_single_eshramcard_data`, userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/eshramcard_document`,
        formdata,
        options
      )
      .then((response) => {
        ...
        <div className="sf-provi-qform">
          <form style={{ marginLeft: "20px" }}>
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <a
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/`+pancard?.bank_passbook_or_cheque_img,
                        `Aadhar_Image_${pancard?._id}.png`
                      )
                    }
                  >
                  ...
                  <img
                    ...
                    width={300}
                    disabled
                    src={`${apiurl[0].apiUrl}uploads/`+pancard?.bank_passbook_or_cheque_img}
                  />
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="form-group">
                  <label>Nominee Aadhar Image</label>
                  <a
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/`+pancard?.nominee_aadhar_img,
                        `Aadhar_Image_${pancard?._id}.png`
                      )
                    }
                  >
                  ...
                  <img
                    ...
                    width={300}
                    disabled
                    src={`${apiurl[0].apiUrl}uploads/`+pancard?.nominee_aadhar_img}
                  />
                </div>
              </div>
              <div className="col-md-4">
...
export default Opeshramdetails;
