...
const Opservicelisttatkalpassport = () => {
  ...
  const voterapprove = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/approve_tatkal_passport`, userdata ,options)
      .then((res) => {
    ...
    <div>
      ...
      <section className="content">
        ...
        <div className="panel panel-default">
          <div className="panel-heading">SERVICES LIST TATKAL PASSPORT</div>
            ...
            <div className="table-responsive">
              {accessdata?.votercard?.length > 0 ? (
                <table className="table">
                  ...
                  <tbody>
                    {accessdata?.tatkalpassport?.map((list, index) => {
                      return (
                        <tr>
                          <td>{index + 1}</td>
                          <td>
...
export default Opservicelisttatkalpassport;
