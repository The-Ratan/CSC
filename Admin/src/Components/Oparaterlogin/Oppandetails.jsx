...
const Oppandetails = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("oppan");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/get_single_pancard_data`, userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/pancard_document`, formdata, options)
      .then((response) => {
