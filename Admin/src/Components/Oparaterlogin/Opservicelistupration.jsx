...
const Opservicelistupration = () => {
  ...
  const voterapprove = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/approve_up_rationcard`, userdata ,options)
      .then((res) => {
    ...
    <div>
      ...
      <section className="content">
        ...
        <div className="panel panel-default">
          <div className="panel-heading">SERVICES LIST UPRATION CARD</div>
              ...
              <table className="table">
                <thead>
                  <tr>
                    ...
                    <tbody>
                    {accessdata?.uprationcard?.map((list,index)=>{
                        return(
<tr>
                        <td>{index + 1}</td>
                        <td>
    ...
    <button
      onClick={() => {
        secureLocalStorage.setItem("opupration", list?._id);
        Navigate('/opupration');
      }}
      type="button"
...
export default Opservicelistupration;
