...
const Opmidtransfer = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("opmidtransfer");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/single_pf_midtransfer_data`, userdata ,options
      )
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/pfmidtransfer_document`,
        formdata,
        options
      )
      .then((response) => {
