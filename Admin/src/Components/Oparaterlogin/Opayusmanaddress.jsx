...
const Opayusmanaddress = () => {
  const [pancard, setaccessdata] = useState();

  let accessdatadid = secureLocalStorage.getItem("opayusmanaddress");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/single_ayushman_address_data`,
        userdata ,options
      )
      .then((res) => {
...
export default Opayusmanaddress;
