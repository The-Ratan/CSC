...
const Opfoodlicense = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("opfoodlicense");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/single_food_license_data`, userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/food_license_document`,
        formdata,
        options
      )
      .then((response) => {
