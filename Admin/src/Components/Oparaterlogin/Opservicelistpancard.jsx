...
const Opservicelistpancard = () => {
  ...
  const panapprove = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/aprove_pancard`, userdata ,options)
      .then((res) => {
                      ...
                      return (
                        <tr>
                          ...
                          <td>
                            <button
                              onClick={() => {
                                secureLocalStorage.setItem("oppan", list?._id);
                                Navigate("/oppandetails");
                              }}
                              type="button"
...
export default Opservicelistpancard;
