...
const Opaadharaddress = () => {
  const [pancard, setaccessdata] = useState();

  let accessdatadid = secureLocalStorage.getItem("opadharaddress");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/single_aadhar_address_data`, userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/aadhar_address_document`,
        formdata,
        options
      )
      .then((response) => {
...
export default Opaadharaddress;
