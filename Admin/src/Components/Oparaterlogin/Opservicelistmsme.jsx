...
const Opservicelistmsme = () => {
  ...
  const voterapprove = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/approve_msme`, userdata ,options)
      .then((res) => {
    ...
    <div>
      ...
      <section className="content">
        ...
        <div className="panel panel-default">
          <div className="panel-heading">SERVICES LIST MSME</div>
            ...
            <div className="table-responsive">
              {accessdata?.votercard?.length > 0 ? (
                <table className="table">
                  ...
                  <tbody>
                    {accessdata?.msme?.map((list, index) => {
                      return (
                        <tr>
                          <td>{index + 1}</td>
                          <td>
                          ...
                          <td>
                            <button
                              onClick={() => {
                                secureLocalStorage.setItem("opmsme", list?._id);
                                Navigate("/opmsme");
                              }}
                              type="button"
...
export default Opservicelistmsme;
