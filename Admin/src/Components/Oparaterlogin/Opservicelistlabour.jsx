...
const Opservicelistlabour = () => {
  ...
  const labourapprove = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/aprove_labourcard`, userdata ,options)
      .then((res) => {
    ...
    <div>
      ...
      <section className="content">
        ...
        <div className="panel panel-default">
          <div className="panel-heading">SERVICES LIST LABOUR CARD</div>
          <div className="panel-body">
            <div className="table-responsive">
              {accessdata?.labourcard?.length > 0 ? (
                <table className="table">
                  ...
                  <tbody>
                    {accessdata?.labourcard?.map((list, index) => {
                      return (
                        <tr>
                          <td>{index + 1}</td>
                          <td>
                          ...
                          <td>
                            <button
                              onClick={() => {
                                secureLocalStorage.setItem("oplabour", list?._id);
                                Navigate("/oplabourdetails");
                              }}
                              type="button"
...
export default Opservicelistlabour;
