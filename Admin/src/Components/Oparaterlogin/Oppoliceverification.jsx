...
const Oppoliceverification = () => {
  const [pancard, setaccessdata] = useState();

  let accessdatadid = secureLocalStorage.getItem("oppoliceverification");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/single_police_verification_data`,
        userdata ,options
      )
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/police_verification_document`,
        formdata,
        options
      )
      .then((response) => {
...
export default Oppoliceverification;
