...
const Oplostreport = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("oplostreport");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/single_lost_report_data`, userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/lostreport_document`,
        formdata,
        options
      )
      .then((response) => {
