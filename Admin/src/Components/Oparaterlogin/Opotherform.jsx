...
const Opotherform = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("opotherform");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/single_other_form_data`, userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/other_form_document`,
        formdata,
        options
      )
      .then((response) => {
