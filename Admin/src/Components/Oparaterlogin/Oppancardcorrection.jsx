...
const Oppancardcorrection = () => {
  const [pancard, setaccessdata] = useState();

  let accessdatadid = secureLocalStorage.getItem("oppancorrection");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/single_pancard_correction_data`,
        userdata ,options
      )
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/pancard_correction_document`,
        formdata,
        options
      )
      .then((response) => {
...
export default Oppancardcorrection;
