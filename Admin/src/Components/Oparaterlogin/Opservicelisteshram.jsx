...
const Opservicelisteshram = () => {
  ...
  const eshramapprove = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/aprove_eshramcard`, userdata ,options)
      .then((res) => {
    ...
    <div>
      ...
      <section className="content">
        ...
        <div className="panel panel-default">
          <div className="panel-heading">SERVICES LIST ESHRAM CARD</div>
          <div className="panel-body">
            <div className="table-responsive">
              {accessdata?.eshramcard?.length > 0 ? (
                <table className="table">
                  ...
                  <tbody>
                    {accessdata?.eshramcard?.map((list, index) => {
                      return (
                        <tr>
                          <td>{index + 1}</td>
                          <td>
                          ...
                          <td>
                            <button
                              onClick={() => {
                                secureLocalStorage.setItem("opeshram", list?._id);
                                Navigate("/opeshramdetails");
                              }}
                              type="button"
...
export default Opservicelisteshram;
