...
const Optatkalpassport = () => {
  const [pancard, setaccessdata] = useState();

  let accessdatadid = secureLocalStorage.getItem("optatkalpassport");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/single_tatkal_passport_data`, userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}subadmin/tatkal_passport_document`,
        formdata,
        options
      )
      .then((response) => {
...
export default Optatkalpassport;
