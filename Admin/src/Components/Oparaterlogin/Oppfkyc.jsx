...
const Oppfkyc = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("oppfkyc");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/single_pf_kyc_data`, userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/pfkyc_document`, formdata, options)
      .then((response) => {
