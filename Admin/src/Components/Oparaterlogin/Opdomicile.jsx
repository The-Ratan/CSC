...
const Opdomicile = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("opdomicile");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/single_domicile_certificate_data`, userdata ,options)
      .then((res) => {
...
const senddata = () => {
  ...
  axios
    .post(
      `${apiurl[0].apiUrl}subadmin/domicile_document`,
      formdata,
      options
    )
    .then((response) => {
      ...
      <section className="content">
        ...
        <form style={{ marginLeft: "20px" }}>
            ...
            >
              ...
              onClick={() =>
                downloadImage(
                  `${apiurl[0].apiUrl}uploads/`+pancard?.sabhasad_or_parshad_letterhead_img,
                  `Aadhar_Image_${pancard?._id}.png`
                )
              }
            >
              Download
                  ...
                  <img
                    ...
                    width={300}
                    disabled
                    src={`${apiurl[0].apiUrl}uploads/`+pancard?.sabhasad_or_parshad_letterhead_img}
                  />
                </div>
              </div>
              ...
              onClick={() =>
                downloadImage(
                  `${apiurl[0].apiUrl}uploads/`+pancard?.svapramanit_ghoshnapatra_or_signature_img,
                  `Aadhar_Image_${pancard?._id}.png`
                )
              }
            >
              Download
                  ...
                  <img
                    ...
                    width={300}
                    disabled
                    src={`${apiurl[0].apiUrl}uploads/`+pancard?.svapramanit_ghoshnapatra_or_signature_img}
                  />
                </div>
              </div>
        ...
        <div className="sf-provi-qform">
          ...
          <br/>
          <h5 className="btn btn-success">Firstly Approve the Document Then you can send the document from your side.</h5>
          <br/>
          <br/>
