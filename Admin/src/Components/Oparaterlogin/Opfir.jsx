...
const Opfir = () => {
  ...
  let accessdatadid = secureLocalStorage.getItem("opfir");
  ...
  const useraccessdata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/single_fir_data`, userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}subadmin/fir_document`, formdata, options)
      .then((response) => {
