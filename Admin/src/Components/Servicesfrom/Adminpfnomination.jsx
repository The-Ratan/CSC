...
const Adminpfnomination = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_pf_nomination_data` ,options)
      .then((res) => {
  ...
  const deleteeshramcard = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_pfnomination`, userdata ,options)
      .then((res) => {
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <img
                            className="media-object"
                            src={`${apiurl[0].apiUrl}uploads/`+list?.pancard_img}
                            width={64}
                            height={64}
                            alt="User Avatar"
                          />
                        ...
                        <td>
                          <button
                            onClick={() => {
                              secureLocalStorage.setItem("pfnomination", list?._id);
                              Navigate("/adminsinglepfnomination");
                            }}
                            type="button"
...
export default Adminpfnomination;
