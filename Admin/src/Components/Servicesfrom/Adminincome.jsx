...
const Adminincome = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_income_certificate_data` ,options)
      .then((res) => {
  ...
  const deleteeshramcard = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_income_certificate`, userdata ,options)
      .then((res) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Income Certificate List</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Income Certificate</li>
          </ol>
        </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button
                            onClick={() => {
                              secureLocalStorage.setItem("income", list?._id);
                              Navigate("/adminsingleincome");
                            }}
                            type="button"
