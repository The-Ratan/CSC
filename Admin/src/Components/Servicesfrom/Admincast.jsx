...
const Admincast = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_cast_certificate_data` ,options)
      .then((res) => {
  ...
  const deleteeshramcard = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_cast_certificate`, userdata ,options)
      .then((res) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Cast Certificate List</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Cast Certificate</li>
          </ol>
        </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button
                            onClick={() => {
                              secureLocalStorage.setItem("cast", list?._id);
                              Navigate("/admisinglecast");
                            }}
                            type="button"
