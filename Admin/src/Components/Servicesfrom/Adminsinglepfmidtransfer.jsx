...
const Adminsinglepfmidtransfer = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("pfmidtransfer");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_pf_midtransfer_data`, Userdata , options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}admin/pfmidtransfer_document`,
        formdata,
        options
      )
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Pf Midtransfer Upload Date - {formattedDateTime}</h1>
...
export default Adminsinglepfmidtransfer;
