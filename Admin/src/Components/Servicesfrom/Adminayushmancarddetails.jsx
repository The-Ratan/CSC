...
const Adminayushmancarddetails = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("ayushmanid");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/get_single_ayushmancard_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/ayushmancard_document`, formdata, options)
      .then((response) => {
...
export default Adminayushmancarddetails;
