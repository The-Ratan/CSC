...
const Adminsingleinsurance = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("insurance");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_insurance_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/insurance_document`, formdata, options)
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Insurance Upload Date - {formattedDateTime}</h1>
...
export default Adminsingleinsurance;
