...
const Adminmsme = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_msme` ,options)
      .then((res) => {
  ...
  const deleteayushmancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_msme`, userdata ,options)
      .then((res) => {
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button
                            onClick={() => {
                              secureLocalStorage.setItem("msme", list?._id);
                              Navigate("/adminsinglemsme");
                            }}
                            type="button"
