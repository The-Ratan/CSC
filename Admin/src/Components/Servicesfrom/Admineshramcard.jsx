...
const Admineshramcard = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/get_eshramcard_details` ,options)
      .then((res) => {
  ...
  const deleteeshramcard = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_eshramcard_details`, userdata ,options)
      .then((res) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Eshram Card List</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Eshram Card</li>
          </ol>
        </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button
                            onClick={() => {
                              secureLocalStorage.setItem("eshramid", list?._id);
                              Navigate("/admineshramcarddetails");
                            }}
                            type="button"
...
export default Admineshramcard;
