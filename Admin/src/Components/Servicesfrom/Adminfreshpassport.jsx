...
const Adminfreshpassport = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_fresh_passport` ,options)
      .then((res) => {
  ...
  const deleteayushmancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_fresh_passport`, userdata ,options)
      .then((res) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Fresh Passport</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Fresh Passport</li>
          </ol>
        </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button
                            onClick={() => {
                              secureLocalStorage.setItem("freshpassport", list?._id);
                              Navigate("/adminsinglefreshpassport");
                            }}
                            type="button"
...
export default Adminfreshpassport;
