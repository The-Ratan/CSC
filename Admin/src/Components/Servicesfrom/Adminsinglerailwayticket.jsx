...
const Adminsinglerailwayticket = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("railwayticket");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_railway_ticket_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}admin/railway_ticket_document`,
        formdata,
        options
      )
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Railway Ticket   Upload Date - {formattedDateTime}</h1>
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <p
                    disabled
                    placeholder={pancard?.ticket_category}
                    className="form-control"
                  >
                    {pancard?.ticket_category}
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                        <div className="form-group">
                          ...
                          {pancard?.passengers?.map((dataa,index)=>{
                             return(
              ...
              <div className="col-md-4">
                <div className="form-group">
                  <label>Irctc Train Status Image</label>
                  <a
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/` +
                          pancard?.irctc_train_status_img,
...
export default Adminsinglerailwayticket;
