...
const Adminsingleaadhar = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("aadhar");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_aadhar_address_data`, Userdata ,options)
      .then((res) => {
...
const formattedDateTime = new Date(createdAt).toLocaleString(undefined, {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}admin/aadhar_address_document`,
        formdata,
        options
      )
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Aadhar Card Upload Date - {formattedDateTime}</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Aadhar Card</li>
          </ol>
        </div>
            ...
            <div className="row">
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <p
                    disabled
                    placeholder={pancard?.aadhar_number}
                    className="form-control"
                  >
                    {pancard?.aadhar_number}
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="form-group">
                  <label>Aadhar Card Linked Number</label>
                  <p
                    disabled
                    placeholder={pancard?.aadhar_linked_phone_no}
                    className="form-control"
                  >
                    {pancard?.aadhar_linked_phone_no}
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <p
                    disabled
                    placeholder={pancard?.category_detail}
                    className="form-control"
                  >
                    {pancard?.category_detail}
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <img
                    disabled
                    src={
                      `${apiurl[0].apiUrl}uploads/` + pancard?.address_proof_img
                    }
                    height={300}
                    width={300}
                  />
...
export default Adminsingleaadhar;
