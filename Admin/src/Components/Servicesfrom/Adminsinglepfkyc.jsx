...
const Adminsinglepfkyc = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("pfkyc");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_pf_kyc_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/pfkyc_document`, formdata, options)
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Pf Kyc  Upload Date - {formattedDateTime}</h1>
...
export default Adminsinglepfkyc;
