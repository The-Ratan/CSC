...
const Adminsingleaayushman = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("aayusman");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_ayushman_address_data`, Userdata ,options)
      .then((res) => {
...
const formattedDateTime = new Date(createdAt).toLocaleString(undefined, {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}admin/ayushman_address_document`,
        formdata,
        options
      )
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Aayushman Card Upload Date - {formattedDateTime}</h1>
...
export default Adminsingleaayushman;
