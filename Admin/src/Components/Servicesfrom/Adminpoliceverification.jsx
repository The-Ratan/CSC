...
const Adminpoliceverification = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_police_verification_data` ,options)
      .then((res) => {
  ...
  const deleteeshramcard = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_police_verification`, userdata ,options)
      .then((res) => {
...
export default Adminpoliceverification;
