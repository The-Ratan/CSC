...
const Admisinglecast = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("cast");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_cast_certificate_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/cast_document`, formdata, options)
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Cast   Upload Date - {formattedDateTime}</h1>
        ...
        <div className="sf-provi-qform">
          <form style={{ marginLeft: "20px" }}>
            <div className="row">
                    ...
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/` +
                          pancard?.sabhasad_or_parshad_letterhead_img,
                        `Aadhar_Image_${pancard?._id}.png`
                      )
                    }
                  >
                ...
                <div className="form-group">
                  ...
                  <a
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/` +
                          pancard?.svapramanit_ghoshnapatra_or_signature_img,
                        `Aadhar_Image_${pancard?._id}.png`
                      )
                    }
                  >
              ...
              <div className="col-md-4">
                <div className="form-group">
                  <label>Jati Praman Patra Image</label>
                  <a
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/` +
                          pancard?.jati_praman_patra_img,
                        `Aadhar_Image_${pancard?._id}.png`
                      )
                    }
                  >
