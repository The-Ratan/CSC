...
const Adminpfwithdraw = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_pf_withdrawal_data` ,options)
      .then((res) => {
  ...
  const deleteeshramcard = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_pfwithdrawal`, userdata ,options)
      .then((res) => {
      ...
      <section className="content">
        <div className="page-heading">
          ...
          <ol className="breadcrumb">
            ...
            <li className="active">Pf Withdraw</li>
          </ol>
        </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button
                            onClick={() => {
                              secureLocalStorage.setItem("pfwithdraw", list?._id);
                              Navigate("/adminsinglepfwithdraw");
                            }}
                            type="button"
...
export default Adminpfwithdraw;
