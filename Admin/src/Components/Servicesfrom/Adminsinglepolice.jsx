...
const Adminsinglepolice = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("policeverification");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}admin/single_police_verification_data`,
        Userdata ,options
      )
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}admin/police_verification_document`,
        formdata,
        options
      )
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Police Verification   Upload Date - {formattedDateTime}</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Police Verification</li>
          </ol>
        </div>
...
export default Adminsinglepolice;
