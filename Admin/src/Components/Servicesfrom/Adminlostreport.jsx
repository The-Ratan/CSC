...
const Adminlostreport = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_lost_report_data` , options)
      .then((res) => {
  ...
  const deleteeshramcard = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_lost_report`, userdata ,options)
      .then((res) => {
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button
                            onClick={() => {
                             secureLocalStorage.setItem("lostreport", list?._id);
                              Navigate("/adminsinglelostreport");
                            }}
                            type="button"
