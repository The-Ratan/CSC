...
const Adminsignledomicile = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("domicile");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}admin/single_domicile_certificate_data`,
        Userdata ,options
      )
      .then((res) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Dmicile Upload Date - {formattedDateTime}</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Domicile</li>
          </ol>
        </div>
...
export default Adminsignledomicile;
