...
const Admininsurance = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_insurance` ,options)
      .then((res) => {
  ...
  const deleteayushmancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_insurance`, userdata ,options)
      .then((res) => {
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button
                            onClick={() => {
                              secureLocalStorage.setItem("insurance", list?._id);
                              Navigate("/adminsingleinsurance");
                            }}
                            type="button"
