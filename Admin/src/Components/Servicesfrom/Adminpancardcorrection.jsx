...
const Adminpancardcorrection = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_pancard_correction_data` ,options)
      .then((res) => {
  ...
  const deleteayushmancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_pancard_correction`, userdata ,options)
      .then((res) => {
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button
                            onClick={() => {
                              secureLocalStorage.setItem("pancorrection", list?._id);
                              Navigate("/adminsinglepancardcorrection");
                            }}
                            type="button"
...
export default Adminpancardcorrection;
