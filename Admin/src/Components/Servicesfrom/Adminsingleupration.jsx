...
const Adminsingleupration = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("upration");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_up_rationcard_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}admin/up_rationcard_document`,
        formdata,
        options
      )
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Up Ration Card   Upload Date - {formattedDateTime}</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Up Ration Card</li>
          </ol>
        </div>
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <p
                    disabled
                    placeholder={pancard?.husband_name}
                    className="form-control"
                  >
                    {pancard?.husband_name}
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <p
                    disabled
                    placeholder={pancard?.rashan_cotedar_name}
                    className="form-control"
                  >
                    {pancard?.rashan_cotedar_name}
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <p
                    disabled
                    placeholder={pancard?.gas_connection_no}
                    className="form-control"
                  >
                    {pancard?.gas_connection_no}
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <p
                    disabled
                    placeholder={pancard?.bijli_bil_no}
                    className="form-control"
                  >
                    {pancard?.bijli_bil_no}
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <img
                    ...
                    disabled
                    src={
                      `${apiurl[0].apiUrl}uploads/` + pancard?.bank_passbook_img
                    }
                  />
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="form-group">
                  <label>Family Aadhar Passbook Image</label>
                  <a
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/` +
                          pancard?.family_aadhar_img,
                        `Aadhar_Image_${pancard?._id}.png`
                      )
                    }
                  >
                  ...
                  <img
                    ...
                    disabled
                    src={
                      `${apiurl[0].apiUrl}uploads/` + pancard?.family_aadhar_img
                    }
                  />
                </div>
              </div>
...
export default Adminsingleupration;
