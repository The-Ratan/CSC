...
const Adminsinglepancardcorrection = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("pancorrection");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_pancard_correction_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}admin/pancard_correction_document`,
        formdata,
        options
      )
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Pancard Correction  Upload Date - {formattedDateTime}</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Pancard Correction</li>
          </ol>
        </div>
        <div className="sf-provi-qform">
          <form style={{ marginLeft: "20px" }}>
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="form-group">
                  <label>Correction proof Image</label>
                  <a
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/` +
                          pancard?.correction_proof_img,
                        `Aadhar_Image_${pancard?._id}.png`
                      )
                    }
                  >
...
export default Adminsinglepancardcorrection;
