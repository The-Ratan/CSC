...
const Adminlabourdetails = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("labourcardid");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/get_single_labourcard_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/labourcard_document`, formdata, options)
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Labour Card Upload Date - {formattedDateTime}</h1>
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <p
                    disabled
                    placeholder={pancard?.work_profile}
                    className="form-control"
                  >
                    {pancard?.work_profile}
                  </p>
                </div>
              </div>
              <div className="col-md-4">
...
export default Adminlabourdetails;
