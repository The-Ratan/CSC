...
const Admineshramcarddetails = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("eshramid");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/get_single_eshramcard_data`, Userdata , options)
      .then((res) => {
...
const formattedDateTime = new Date(createdAt).toLocaleString(undefined, {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/eshramcard_document`, formdata, options)
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Eshram Card Upload Date - {formattedDateTime}</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Eshram</li>
          </ol>
        </div>
...
export default Admineshramcarddetails;
