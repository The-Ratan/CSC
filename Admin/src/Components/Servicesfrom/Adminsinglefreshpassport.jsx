...
const Adminsinglefreshpassport = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("freshpassport");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_fresh_passport_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}admin/fresh_passport_document`,
        formdata,
        options
      )
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Fresh Passport Upload Date - {formattedDateTime}</h1>
...
export default Adminsinglefreshpassport;
