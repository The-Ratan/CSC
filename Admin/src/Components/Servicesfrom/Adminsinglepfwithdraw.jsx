...
const Adminsinglepfwithdraw = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("pfwithdraw");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_pf_withdrawal_data`, Userdata ,options) 
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/pfwithdrawal_document`, formdata, options)
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Pf Withdraw   Upload Date - {formattedDateTime}</h1>
...
export default Adminsinglepfwithdraw;
