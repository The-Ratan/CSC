...
const Adminsinglelostreport = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("lostreport");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_lost_report_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/lostreport_document`, formdata, options)
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Lost Report Upload Date - {formattedDateTime}</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Lost Report</li>
          </ol>
        </div>
        <div className="sf-provi-qform">
          <form style={{ marginLeft: "20px" }}>
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="form-group">
                  <label>Fir Content Image</label>
                  <a
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/`+pancard?.fir_content_img,
                        `Aadhar_Image_${pancard?._id}.png`
                      )
                    }
                  >
                  ...
                  <img
                    ...
                    width={300}
                    disabled
                    src={`${apiurl[0].apiUrl}uploads/`+pancard?.fir_content_img}
                  />
                </div>
              </div>
...
export default Adminsinglelostreport;
