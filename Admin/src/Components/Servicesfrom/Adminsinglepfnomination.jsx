...
const Adminsinglepfnomination = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("pfnomination");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_pf_nomination_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/pfnomination_document`, formdata, options)
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Pf Nomination  Upload Date - {formattedDateTime}</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Pf Nomination</li>
          </ol>
        </div>
...
export default Adminsinglepfnomination;
