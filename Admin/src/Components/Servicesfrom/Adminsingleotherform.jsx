...
const Adminsingleotherform = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("otherform");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_other_form_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/other_form_document`, formdata, options)
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Other Form Upload Date - {formattedDateTime}</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Other Form</li>
          </ol>
        </div>
        <div className="sf-provi-qform">
          <form style={{ marginLeft: "20px" }}>
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="form-group">
                  <label>Tenth Result Image</label>
                  <a
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/` +
                          pancard?.tenth_result_img,
                        `Aadhar_Image_${pancard?._id}.png`
                      )
                    }
                  >
                  ...
                  <img
                    ...
                    disabled
                    src={
                      `${apiurl[0].apiUrl}uploads/` + pancard?.tenth_result_img
                    }
                  />
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  <a
                    onClick={() =>
                      downloadImage(
                        `${apiurl[0].apiUrl}uploads/` + pancard?.add_document,
                        `Aadhar_Image_${pancard?._id}.png`
                      )
                    }
                  >
                  ...
                  <img
                    ...
                    width={300}
                    disabled
                    src={`${apiurl[0].apiUrl}uploads/` + pancard?.add_document}
                  />
                </div>
              </div>
...
export default Adminsingleotherform;
