...
const Admindomicile = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_domicile_certificate_data` ,options)
      .then((res) => {
  ...
  const deleteeshramcard = (item) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_domicile_certificate` ,userdata ,options )
      .then((res) => {
  ...
  return (
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Domicile Certificate List</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Domicile Certificate</li>
          </ol>
        </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <img
                            className="media-object"
                            src={`${apiurl[0].apiUrl}uploads/`+list?.sabhasad_or_parshad_letterhead_img}
                            width={64}
                            height={64}
                            alt="User Avatar"
                          />
                        ...
                        <td> <button onClick={() =>deleteid(list?._id)} data-toggle="modal"
    ...
    <button
      onClick={() => {
        secureLocalStorage.setItem("domicile", list?._id);
        Navigate('/adminsignledomicile');
      }}
      type="button"
