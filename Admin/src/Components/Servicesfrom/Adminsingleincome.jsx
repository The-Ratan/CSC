...
const Adminsingleincome = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("income");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/single_income_certificate_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/income_document`, formdata, options)
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Income Upload Date - {formattedDateTime}</h1>
...
export default Adminsingleincome;
