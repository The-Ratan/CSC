...
const Adminvotercarddetails = () => {
  const [pancard, setpancard] = useState();

  let id = secureLocalStorage.getItem("voterid");
  ...
  const deletepancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/get_single_votercard_data`, Userdata ,options)
      .then((res) => {
  ...
  const senddata = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/votercard_document`, formdata, options)
      .then((response) => {
    ...
    <>
      ...
      <section className="content">
        <div className="page-heading">
          <h1>Voter Card   Upload Date - {formattedDateTime}</h1>
          <ol className="breadcrumb">
            <li>
              <Link to="/deashboard">Dashboard</Link>
            </li>

            <li className="active">Voter Card</li>
          </ol>
        </div>
...
export default Adminvotercarddetails;
