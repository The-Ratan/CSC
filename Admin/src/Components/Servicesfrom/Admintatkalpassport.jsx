...
const Admintatkalpassport = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_tatkal_passport` ,options)
      .then((res) => {
  ...
  const deleteayushmancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_tatkal_passport`, userdata ,options)
      .then((res) => {
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button
                            onClick={() => {
                              secureLocalStorage.setItem("tatkalpassport", list?._id);
                              Navigate("/adminsingletatkalpassport");
                            }}
                            type="button"
...
export default Admintatkalpassport;
