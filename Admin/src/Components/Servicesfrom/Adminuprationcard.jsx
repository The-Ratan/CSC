...
const Adminuprationcard = ({ data }) => {
  ...
  const userlist = () => {
    axios
      .get(`${apiurl[0].apiUrl}admin/all_up_rationcard_data` ,options)
      .then((res) => {
  ...
  const deleteayushmancard = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}admin/delete_up_rationcard`, userdata ,options)
      .then((res) => {
      ...
      <section className="content">
        <div className="page-heading">
          ...
          <ol className="breadcrumb">
            ...
            <li className="active">Uprationcard</li>
          </ol>
        </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button
                            onClick={() => {
                              secureLocalStorage.setItem("upration", list?._id);
                              Navigate("/adminsingleupration");
                            }}
                            type="button"
...
export default Adminuprationcard;
