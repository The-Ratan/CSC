...
const Foodlicense1 = () => {
  ...
  const [office_address_proof_img, setsignature_img] = useState("");
  ...
  const senddata = (evt) => {
    ...
    if (isConfirmed) {
      ...
      if (office_address_proof_img && office_address_proof_img.size > 200 * 1024) {
        toast.error("Office Address Image size should be less than 200KB");
        return; 
      }
      ...
      formdata.append("office_address_proof_img", office_address_proof_img);
      ...
      axios
        .post(
          `${apiurl[0].apiUrl}website/add_food_license_details`,
          formdata,
          options
        )
        .then((response) => {
          ...
          setTimeout(() => {
            window.location.reload("/foodlicense1");
          }, 3000);
        })
        .catch((error) => {});
        ...
        <div id="content">
          <div className="content-admin-main">
            ...
            <div className="aon-admin-heading">
              <h4>
                <strong>Please Fill this detail for Food License</strong>
              </h4>
            </div>
