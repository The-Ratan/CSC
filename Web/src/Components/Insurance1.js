...
const Insurance1 = () => {
  ...
  const [rc_img, setrc_img] = useState("");
  const [owner_id_img, setowner_id_img] = useState("");
  const [old_insurance_img, setold_insurance_img] = useState("");
  ...
  const senddata = (evt) => {
    ...
    if (isConfirmed) {
      if (rc_img && rc_img.size > 200 * 1024) {
        toast.error("RC Image size should be less than 200KB");
        return; 
      }
      if (owner_id_img && owner_id_img.size > 200 * 1024) {
        toast.error("Owner ID Image size should be less than 200KB");
        return; 
      }

      if (old_insurance_img && old_insurance_img.size > 200 * 1024) {
        toast.error("Old Insurance  Image size should be less than 200KB");
        return; 
      }
      ...
      formdata.append("rc_img", rc_img);
      formdata.append("owner_id_img", owner_id_img);
      formdata.append("old_insurance_img", old_insurance_img);
      ...
      axios
        .post(`${apiurl[0].apiUrl}website/add_insurance_details`
         ,
          formdata,
          options
        )
        .then((response) => {
          ...
          setTimeout(() => {
            window.location.reload("/insurance1");
          }, 3000);
        })
        .catch((error) => {
        ...
        <div id="content">
          <div className="content-admin-main">
            ...
            <div className="aon-admin-heading">
              <h4>
                <strong>Please Fill this detail for Insurance </strong>
              </h4>
            </div>
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          ...
                          >
                            ...
                            <option>1st Party Insurance</option>
                ...
                <div className="col-md-6">
                  <div className="sf-provi-qform">
                    <div className="row">
                        ...
                        <div className="aon-inputicon-box">
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) => setrc_img(e.target.files[0])}
                                type="file"
                                accept="image/*"
                              />
                            </div>
                      ...
                      <div className="col-md-12">
                        <h4>
                          Owner ID(Aadhar Card , Pan Card , Voter Card ,
                          License)
                        </h4>
                        <div className="aon-inputicon-box">
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) => setowner_id_img(e.target.files[0])}
                                type="file"
                                accept="image/*"
                              />
                            </div>
                      ...
                      <div className="col-md-12">
                        <h4>Old Insurance Copy</h4>
                        <div className="aon-inputicon-box">
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) => setold_insurance_img(e.target.files[0])}
                                type="file"
                                accept="image/*"
                              />
                            </div>
