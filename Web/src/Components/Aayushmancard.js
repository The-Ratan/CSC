...
const Aayushmancard = () => {
  ...
  const senddata = (evt) => {
    ...
    if (isConfirmed) {
      ...
      axios
        .post(
          `${apiurl[0].apiUrl}website/add_ayushmancard_details`,
          formdata,
          options
        )
        .then((response) => {
          ...
          setTimeout(() => {
            window.location.reload("/aayushmancard");
          }, 3000);
        })
        .catch((error) => {});
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          ...
                          <select
                            onChange={(e) => setcategory_detail(e.target.value)}
                          ...
                          >
                            ...
                            <option>FATHER NAME CHANGES</option>
                            <option>MOTHER NAME CHANGES</option>
                          </select>
                        </div>
                      </div>
