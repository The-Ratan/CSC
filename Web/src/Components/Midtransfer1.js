...
import secureLocalStorage from "react-secure-storage";
  ...
  const Midtransfer1 = () => {
    ...
    const senddata = (evt) => {
      ...
      axios
        .post(
          `${apiurl[0].apiUrl}website/add_pf_midtransfer_details`,
          formdata,
          options
        )
        .then((response) => {
          ...
          setTimeout(() => {
            window.location.reload("/midtransfer1");
          }, 3000);
        })
        .catch((error) => {
          ...
          <div id="content">
            ...
            <div className="admin-top-area d-flex flex-wrap justify-content-between m-b30 align-items-center">
              ...
              <div className="aon-admin-heading">
                <h4>
                  <strong>Please Fill this detail for Midtransfer</strong>
                </h4>
              </div>
