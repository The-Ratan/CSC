...
const Aadharcard1 = () => {
  ...
  const senddata = (evt) => {
    ...
    if (isConfirmed) {
      ...
      if (address_proof_img && address_proof_img.size > 200 * 1024) {
        toast.error("Address Proof Image size should be less than 200KB");
        return; 
      }
      ...
      formdata.append("aadhar_linked_phone_no", phone_no);
      ...
      axios
        .post(
          `${apiurl[0].apiUrl}website/add_aadhar_address_change_details`,
          formdata,
          options
        )
        .then((response) => {
          ...
          setTimeout(() => {
            window.location.reload("/aadharcard1");
          }, 3000);
        })
        .catch((error) => {});
          ...
          <div className="content-admin-main">
            <div className="admin-top-area d-flex flex-wrap justify-content-between m-b30 align-items-center">
              <div className="admin-left-area">
                <a
                  href="/aayushmancardaddresschange1"
              ...
              <div className="admin-left-area">
                <a
                  ...
                  className="nav-btn-admin d-flex justify-content-between align-items-center"
                >
                  Aadhar Card (Address Change Only)
                </a>
              </div>
            </div>
            <div className="aon-admin-heading">
              <h4>
                <strong>Please Fill this detail for Aadhar Card</strong>
              </h4>
            </div>
                ...
                <div className="col-md-6">
                  <div className="sf-provi-qform">
                    <div className="row">
                      <div className="col-md-12">
                        <h4>
                          UPLOAD ADDRESS PROOF (Signed UIDAI Format , Voter ID
                          Card , License)
                        </h4>
