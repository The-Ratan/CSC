                            ...
                            {data?.approve_status == 0 ? (
                              ...
                              <>
                                ...
                                <a
                                  onClick={() =>
                                    downloadImage(
                                      `http://103.104.74.215:3099/uploads/${data?.document1}`,
                                      `Pdf_${data?._id}.png`
                                    )
                                  }
                                >
                                ...
                                <a
                                  onClick={() =>
                                    downloadImage(
                                      `http://103.104.74.215:3099/uploads/${data?.document2}`,
                                      `Pdf_${data?._id}.png`
                                    )
                                  }
                                >
                            ...
                            {data?.approve_status == 0 ? (
                              ...
                              <>
                                ...
                                <a
                                  onClick={() =>
                                    downloadImage(
                                      `${apiurl[0].apiUrl}uploads/`+data?.document1,
                                      `Pdf_${data?._id}.png`
                                    )
                                  }
                                >
                                ...
                                <a
                                  onClick={() =>
                                    downloadImage(
                                      `${apiurl[0].apiUrl}uploads/`+data?.document2,
                                      `Pdf_${data?._id}.png`
                                    )
                                  }
                                >
...
<button data-toggle="modal" data-target="#documentModal" 
  ...
  onClick={() => { 
    secureLocalStorage.setItem("docid", data?._id);
    secureLocalStorage.setItem("typeofdoc", "ayushmancard");
    secureLocalStorage.setItem("paymentofdoc", data?.payment);
    // toggleDocumentModal();
  }}
>
