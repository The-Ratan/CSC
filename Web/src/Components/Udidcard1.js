...
const Udidcard1 = () => {
  ...
  const [father_or_mother_aadhar_img, setfather_or_mother_aadhar_img] =
    useState("");
  const [disability_certificate, setdisability_certificate] = useState("");
   ...
   const senddata = (evt) => {
    ...
    if (isConfirmed) {
      ...
      if (signature_img && signature_img.size > 200 * 1024) {
        toast.error("10th Marksheet Image size should be less than 200KB");
        return; 
      }
      
      if (father_or_mother_aadhar_img && father_or_mother_aadhar_img.size > 200 * 1024) {
        toast.error("Father & Mother Aadhar Image size should be less than 200KB");
        return; 
      }

      
      if (disability_certificate && disability_certificate.size > 200 * 1024) {
        toast.error("Disability Certificate Image size should be less than 200KB");
        return; 
      }
    ...
    let otpidd = secureLocalStorage.getItem("otpid");
    ...
    formdata.append("user_id", otpidd);
    formdata.append("name", name);
    formdata.append("father_name", father_name);
    formdata.append("mother_name", mother_name);
    formdata.append("aadhar_linked_phon_no", phone_no);
    formdata.append("disability_type", disability_type);

    formdata.append("message", message ? message : "");
    formdata.append("aadhar_img", aadhar_img);
    formdata.append("father_or_mother_aadhar_img", father_or_mother_aadhar_img);
    formdata.append("signature_img", signature_img);
    formdata.append("disability_certificate", disability_certificate);
    ...
    axios
      .post(
        `${apiurl[0].apiUrl}website/add_udidcard_details`,
        formdata,
        options
      )
      .then((response) => {
       ...
       setTimeout(() => {
           window.location.reload("/udidcard1");
         }, 3000);
      })
      .catch((error) => {
        ...
        <div id="content">
          <div className="content-admin-main">
            ...
            <div className="aon-admin-heading">
              <h4>
                <strong>Please Fill this detail UDID</strong>
              </h4>
            </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          ...
                          <select
                            onChange={(e) => setdisability_type(e.target.value)}
                            className="form-control"
                          >
                ...
                <div className="col-md-6">
                  <div className="sf-provi-qform">
                    <div className="row">
                      ...
                      <div className="col-md-12">
                        <h4>FATHER / MOTHER AADHAR CARD</h4>
                        <div className="aon-inputicon-box">
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) =>
                                  setfather_or_mother_aadhar_img(
                                    e.target.files[0]
                                  )
                                }
                                type="file"
                      ...
                      <div className="col-md-12">
                        <h4>DISABILITY CERTIFICATE IF ANY </h4>
                        <div className="aon-inputicon-box">
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) =>
                                  setdisability_certificate(e.target.files[0])
                                }
                                type="file"
                                accept="image/*"
                              />
