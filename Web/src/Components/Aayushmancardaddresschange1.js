...
const Aayushmancardaddresschange1 = () => {
  ...
  const senddata = (evt) => {
    ...
    if (isConfirmed) {
      ...
      axios
        .post(
          `${apiurl[0].apiUrl}website/add_ayushman_address_change_details`,
          formdata,
          options
        )
        .then((response) => {
          ...
          setTimeout(() => {
            window.location.reload("/aayushmancardaddresschange1");
          }, 3000);
        })
        .catch((error) => {});
        ...
        <div id="content">
          <div className="content-admin-main">
            ...
            <div className="aon-admin-heading">
              <h4>
                <strong>Please Fill this detail for Aayushman Card</strong>
              </h4>
            </div>
...
export default Aayushmancardaddresschange1;
