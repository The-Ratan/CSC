...
const Voteridcard1 = () => {
  ...
  const [family_voterid_img, setfamily_voterid_img] = useState("");
  ...
  const senddata = (evt) => {
    ...
    if (isConfirmed) {
      ...
      if (family_voterid_img && family_voterid_img.size > 200 * 1024) {
        toast.error("Family Voterid Image size should be less than 200KB");
        return; 
      }
    ...
    formdata.append("family_voterid_img", family_voterid_img);
    ...
    axios
      .post(`${apiurl[0].apiUrl}website/add_voterid_details`, formdata ,options)
      .then((response) => {
        setsimbolstatusstatus(false);
        setloaderstatus(true);
        toast.success(response.data.msg);
        setTimeout(() => {
          window.location.reload('/voteridcard1');
        }, 3000);
      })
      .catch((error) => {
        ...
        <div id="content">
          <div className="content-admin-main">
            ...
            <div className="aon-admin-heading">
              <h4>
                <strong>Please Fill this detail Voter id Card</strong>
              </h4>
            </div>
            <form onSubmit={senddata} encType="multipart/form-data">
                          ...
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) =>
                                  setfamily_voterid_img(e.target.files[0])
                                }
                                type="file"
                                accept="image/*"
                              />
              ...
              <div class="checkbox sf-radio-checkbox ">
                <input value={term} onChange={((e)=>{setterm(e.target.value)})} id="td2_2" name="abc"  type="checkbox" />
