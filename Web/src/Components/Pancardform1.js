...
const Pancardform1 = () => {
  ...
  const senddata = (evt) => {
    ...
    if (isConfirmed) {
      ...
      formdata.append(
        "address",
        address ? address : "DELIVERY ADDRESS WILL SAME AS ON AADHAR"
      );
      ...
      axios
        .post(
          `${apiurl[0].apiUrl}website/add_pancard_details`,
          formdata,
          options
        )
        .then((response) => {
        ...
        <div id="content">
          <div className="content-admin-main">
            ...
            <div className="aon-admin-heading">
              <h4>
                <strong>Please Fill this detail for Pancard</strong>
              </h4>
            </div>
