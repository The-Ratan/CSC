...
import secureLocalStorage from "react-secure-storage";
  ...
  const Pancardcorrections1 = () => {
    ...
    const [correction_proof_img, setcorrection_proof_img] = useState("");
    ...
    const senddata = (evt) => {
      ...
      if (isConfirmed) {
        ...
        if (correction_proof_img && correction_proof_img.size > 200 * 1024) {
          toast.error("Correction Proof Image size should be less than 200KB");
          return; 
        }
      ...
      formdata.append("address", address ? address : "DELIVERY ADDRESS WILL SAME AS ON AADHAR");
      formdata.append("message", message ? message : "");
      formdata.append("aadhar_img", aadhar_img);
      formdata.append("user_img", user_img);
      formdata.append("correction_proof_img", correction_proof_img);
      ...
      axios
        .post(
          `${apiurl[0].apiUrl}website/add_pancard_correction_details`,
          formdata,
          options
        )
        .then((response) => {
          ...
          setTimeout(() => {
            window.location.reload("/pancardcorrection1");
          }, 3000);
        })
        .catch((error) => {
        ...
        <div className="page-wraper">
          ...
          <div id="content">
            ...
            <div className="admin-top-area d-flex flex-wrap justify-content-between m-b30 align-items-center">
              ...
              <div className="admin-left-area">
                <a href='/pancardcorrections1'
                  className="nav-btn-admin d-flex justify-content-between align-items-center"
                  
                >
                  Correction/Change in Pan Card
                </a>
              </div>
            </div>
              <div className="aon-admin-heading">
                <h4>
                  <strong>Please Fill this detail for pancard correction/change</strong>
                </h4>
              </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            >
                              ...
                              <option>
                                DELIVERY ADDRESS WILL SAME AS ON AADHAR
                              </option>
                          ...
                          {showAdditional && (
                            <div>
                              <font style={{ color: "red" }}>
                                EXTRA CHARGES MAY BE APPLY
                              </font>
                              <br />
  
                              <div>
                                    <input placeholder="House No. Street No. Area Tehsil State-Pin"
                                      className="form-control"
                                      value={address}
                            ...
                            <div className="radio-inline-box service-perform-list">
                              <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                                <input
                                  required
                                  onChange={(e) =>
                                    setcorrection_proof_img(e.target.files[0])
                                  }
                                  type="file"
                                  accept="image/*"
                                />
  ...
  export default Pancardcorrections1;
