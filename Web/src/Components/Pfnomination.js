...
import secureLocalStorage from "react-secure-storage";
  ...
  const Pfnomination = () => {
    ...
    const [pancard_img, setpancard_img] = useState("");
   
    const [bank_passbook_or_cheque_img, setbank_passbook_or_cheque_img] =
      useState("");
      const [nominee_aadhar_img, setnominee_aadhar_img] =
      useState("");
    ...
    const senddata = (evt) => {
      ...
      if (isConfirmed) {
        ...
        axios
          .post(
            `${apiurl[0].apiUrl}website/add_pf_nomination_details`,
            formdata,
            options
          )
          .then((response) => {
            ...
            setTimeout(() => {
              window.location.reload("/pfnomination");
            }, 3000);
          })
          .catch((error) => {
          ...
          <div id="content">
            ...
            <div className="admin-top-area d-flex flex-wrap justify-content-between m-b30 align-items-center">
              ...
              <div className="aon-admin-heading">
                <h4>
                  <strong>Please Fill this detail for Pfnomination</strong>
                </h4>
              </div>
                ...
                <div className="col-md-6">
                  <div className="sf-provi-qform">
                    <div className="row">
                          ...
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) =>
                                  setpancard_img(e.target.files[0])
                                }
                                type="file"
                                accept="image/*"
                              />
                      ...
                      <div className="col-md-12">
                        <h4>UPLOAD NOMINEE AADHAR CARD</h4>
                        <div className="aon-inputicon-box">
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
