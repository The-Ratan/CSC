...
const Labourcard1 = () => {
  ...
  const [bank_passbook_or_cheque_img, setbank_passbook_or_cheque_img] = useState("");
  ...
  const senddata = (evt) => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}website/add_labourcard_details`, formdata ,options)
      .then((response) => {
        ...
        setTimeout(() => {
          window.location.reload('/labourcard1');
        }, 3000);
      })
      .catch((error) => {
        ...
        <div id="content">
          <div className="content-admin-main">
            ...
            <div className="aon-admin-heading">
              <h4>
                <strong>Please Fill this detail for Labour Card</strong>
              </h4>
            </div>
