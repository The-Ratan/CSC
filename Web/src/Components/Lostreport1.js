...
import secureLocalStorage from "react-secure-storage";
  ...
  const Lostreport1 = () => {
    ...
    const [fir_content_img, setfir_content_img] = useState("");  
    ...
    const senddata = (evt) => {
      ...
      if (isConfirmed) {
        ...
        if (fir_content_img && fir_content_img.size > 200 * 1024) {
          toast.error("Fir Content Image size should be less than 200KB");
          return; 
        }
      ...
      formdata.append("fir_content_img", fir_content_img);
      ...
      axios
        .post(
          `${apiurl[0].apiUrl}website/add_lost_report_details`,
          formdata,
          options
        )
        .then((response) => {
          ...
          setTimeout(() => {
            window.location.reload("/lostreport1");
          }, 3000);
        })
        .catch((error) => {
          ...
          <div id="content">
            ...
            <div className="admin-top-area d-flex flex-wrap justify-content-between m-b30 align-items-center">
              ...
              <div className="aon-admin-heading">
                <h4>
                  <strong>Please Fill this detail for Lost Report</strong>
                </h4>
              </div>
                ...
                <div className="col-md-6">
                  <div className="sf-provi-qform">
                    <div className="row">
                      ...
                      <div className="col-md-12">
                        <h4>FIR CONTENT WITH IMAGE </h4>
                        <div className="aon-inputicon-box">
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) => setfir_content_img(e.target.files[0])}
                                type="file"
                                accept="image/*"
                                name="abc"
                              />
