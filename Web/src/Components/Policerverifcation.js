...
import secureLocalStorage from "react-secure-storage";
      ...
      if (isConfirmed) {
        ...
        axios
          ...
          .then((response) => {
            ...
            setTimeout(() => {
              window.location.reload("/policeverification");
            }, 3000);
          })
          .catch((error) => {
          ...
          <div id="content">
            <div className="content-admin-main">
              ...
              <div className="aon-admin-heading">
                <h4>
                  <strong>Please Fill this detail for Policerverifcation</strong>
                </h4>
              </div>
  ...
  export default Policerverifcation;
