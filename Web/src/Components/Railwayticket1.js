...
const Railwayticket1 = () => {
  ...
  const handleAddPassenger = () => {
    if (passengers.length < MAX_PASSENGERS) {
      ...
      toast.error("Maximum Limit Of Passengers Reached (20).");
    }
  };
  ...
  const [irctc_train_status_img, setirctc_train_status_img] = useState("");
  ...
  const senddata = (evt) => {
    ...
    if (isConfirmed) {
      if (irctc_train_status_img && irctc_train_status_img.size > 200 * 1024) {
        toast.error("IRCTC Train Status Image size should be less than 200KB");
        return; 
      }
      ...
      formdata.append("train_no", train_no);
      formdata.append("ticket_category", ticket_category);
      formdata.append("phone_no", phone_no);
      // formdata.append("passengers", passengers);
      formdata.append("passengers", JSON.stringify(passengers));

      formdata.append("irctc_train_status_img", irctc_train_status_img);
      ...
      axios
        .post(
          `${apiurl[0].apiUrl}website/add_railway_ticket_details`,
          formdata,
          options
        )
        .then((response) => {
          ...
          setTimeout(() => {
            window.location.reload("/railwayticket1");
          }, 3000);
        })
        .catch((error) => {
        ...
        <div id="content">
          <div className="content-admin-main">
            ...
            <div className="aon-admin-heading">
              <h4>
                <strong>Please Fill this detail for Railway Ticket</strong>
              </h4>
            </div>
              ...
              <div className="row">
                  ...
                  <div className="sf-provi-qform">
                    <div className="row">
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          <label>
                            MOBILE NUMBER (Passenger phone number as per IRCTC
                            guidelines & SMS will be sent to this number.){" "}
                          </label>
                          <input
                            onChange={(e) =>
                ...
                <div className="col-md-6">
                  <div className="sf-provi-qform">
                    <div className="row">
                      <div className="col-md-12">
                        <h4>IRCTC Train Status Screenshot </h4>
                          ...
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) =>
                                  setirctc_train_status_img(e.target.files[0])
                                }
                                type="file"
                                accept="image/*"
                              />
