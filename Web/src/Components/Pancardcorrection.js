...
import secureLocalStorage from "react-secure-storage";
  ...
  const Pancardcorrection = () => {
    ...
    const senddata = (evt) => {
      ...
      if (isConfirmed) {
        ...
        axios
          .post(`${apiurl[0].apiUrl}website/add_pancard_correction_details`
            ,
            formdata,
            options
          )
          .then((response) => {
            ...
            setTimeout(() => {
              window.location.reload("/pancardcorrection");
            }, 3000);
          })
          .catch((error) => {
          ...
          <div id="content">
            <div className="content-admin-main">
              <div className="admin-top-area d-flex flex-wrap justify-content-between m-b30 align-items-center">
                ...
                <div className="admin-left-area">
                  <a href='/pancardcorrection'
                    className="nav-btn-admin d-flex justify-content-between align-items-center"
                    
                  >
                    Correction Change in Pancard
                  </a>
                </div>
              </div>
              <div className="aon-admin-heading">
                <h4>
                  <strong>Please Fill this detail for correction</strong>
                </h4>
              </div>
                        ...
                        <div class="col-md-12">
                          ...
                          {showAdditional && (
                            <div>
                              ...
                              <div>
                                <input
                                  placeholder="House No. Street No. Area Tehsil State-Pin"
                                  className="form-control"
                                  value={address}
  ...
  export default Pancardcorrection;
