...
import { GrServices, GrUserPolice } from "react-icons/gr";
      ...
      <div className="page-wraper">
        ...
        >
          <div className="content-admin-main">
            ...
            <Slider {...settings}>
              <div
                onClick={() => window.location.reload(Navigate("/insurance"))}
              ...
              <div
                onClick={() => window.location.reload(Navigate("/pancardform"))}
                className="col-lg-2 mb-4 text-center clickk1"
                style={{
                  marginLeft: "5px",
                  marginRight: "5px",
              ...
              <div
                onClick={() => window.location.reload(Navigate("/railwayticket"))}
                className="col-lg-2 mb-4 text-center clickk1"
                style={{
                  marginLeft: "5px",
                  marginRight: "5px",
              ...
              <div
                onClick={() => window.location.reload(Navigate("/voteridcard"))}
                className="col-lg-2 mb-4 text-center clickk1"
                style={{
                  marginLeft: "5px",
                  marginRight: "5px",
              ...
              <div
                onClick={() => window.location.reload(Navigate("/pfwithdraw"))}
                className="col-lg-2 mb-4 text-center clickk1"
                style={{
                  marginLeft: "5px",
                  marginRight: "5px",
              ...
              <div
                onClick={() => window.location.reload(Navigate("/msme"))}
                className="col-lg-2 mb-4 text-center clickk1"
                style={{
                  marginLeft: "5px",
                  marginRight: "5px",
              ...
              <div
                onClick={() => window.location.reload(Navigate("/other"))}
                className="col-lg-2 mb-4 text-center clickk1"
                style={{
                  marginLeft: "5px",
                  marginRight: "5px",
              ...
              <div
                onClick={() => window.location.reload(Navigate("/eshramcard"))}
                className="col-lg-2 mb-4 text-center clickk1"
                style={{
                  marginLeft: "5px",
                  marginRight: "5px",
              ...
              >
                <FaStackExchange style={{ fontSize: "30px", color: "white" ,marginLeft:'0px' }}/>
                Uan
              </div>
            </Slider>
