...
const Cast = () => {
  ...
  const [
    ...
    setsabhasad_or_parshad_letterhead_img,
  ] = useState("");
  const [jati_praman_patra_img, setjati_praman_patra_img] = useState("");
  ...
  const senddata = (evt) => {
    ...
    if (isConfirmed) {
      ...
      if (jati_praman_patra_img && jati_praman_patra_img.size > 200 * 1024) {
        toast.error("Caste Certificate Image size should be less than 200KB");
        return; 
      }
      ...
      formdata.append("jati_praman_patra_img", jati_praman_patra_img);
      formdata.append(
      ...
      axios
        .post(
          `${apiurl[0].apiUrl}website/add_cast_certificate_details`,
          formdata,
          options
        )
        .then((response) => {
        ...
        <div id="content">
          <div className="content-admin-main">
            ...
            <div className="aon-admin-heading">
              <h4>
                <strong>Please Fill this detail for Caste</strong>
              </h4>
            </div>
                          ...
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) =>
                                  setjati_praman_patra_img(e.target.files[0])
                                }
                                type="file"
                                accept="image/*"
                              />
                          ...
                          <div>
                            ...
                            <div className="">
                              <input
                                ...
                                name="name"
                                type="text"
                                placeholder="Enter detail if you want"
                                required
                                className="form-control"
                              />
                            </div>
