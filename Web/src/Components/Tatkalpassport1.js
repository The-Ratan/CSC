...
import secureLocalStorage from "react-secure-storage";
  ...
  const Tatkalpassport1 = () => {
    ...
    const senddata = (evt) => {
        ...
        if (isConfirmed) {
          ...
          axios
            .post(
              `${apiurl[0].apiUrl}website/add_tatkal_passport_details`,
              formdata,
              options
            )
            .then((response) => {
              ...
              setTimeout(() => {
                window.location.reload("/tatkalpassport1");
              }, 3000);
            })
            .catch((error) => {
          ...
          <div id="content">
            <div className="content-admin-main">
              ...
              <div className="aon-admin-heading">
                <h4>
                  <strong>Please Fill this detail for Tatkal Passport</strong>
                </h4>
              </div>
  ...
  export default Tatkalpassport1;
