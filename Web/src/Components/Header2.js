...
const Header2 = () => {
  ...
  const userId = secureLocalStorage.getItem("operatorid");
                    ...
                    >
                      <a href="#">
                        ...
                        <img
                          ...
                          alt=""
                          style={{ height: "55%", marginBottom: "13px" }}
                        />
                        {/* </span> */}
                      </a>
                    </div>
                        ...
                        <ul className="user-welcome-list">
                          ...
                          <li>
                            <a href="/changepassword">
                              <i className="feather-settings" /> Change Password
                            </a>
                          </li>
                          <li>
                            <a onClick={logout}>
