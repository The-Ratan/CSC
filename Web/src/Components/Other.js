...
const Other = () => {
  ...
  const [tenth_result_img, settenth_result_img] = useState("");
  const [add_document, setadd_document] = useState("");
  ...
  const senddata = (evt) => {
    ...
    if (isConfirmed) {
      ...
      if (tenth_result_img && tenth_result_img.size > 200 * 1024) {
        toast.error("10th Result Image size should be less than 200KB");
        return; 
      }

      if (add_document && add_document.size > 200 * 1024) {
        toast.error("Add Documents Image size should be less than 200KB");
        return; 
      }
      ...
      formdata.append("tenth_result_img", tenth_result_img);
      formdata.append("add_document", add_document);
      ...
      axios
        .post(`${apiurl[0].apiUrl}website/add_other_form_details`
          ,
          formdata,
          options
        )
        ...
        <div id="content">
          <div className="content-admin-main">
            ...
            <div className="aon-admin-heading">
              <h4>
                <strong>Please Fill this detail Other</strong>
              </h4>
            </div>
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          ...
                          >
                            ...
                            <option>Instant Service (Frequently Used Services)</option>
                          ...
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) =>
                                  settenth_result_img(e.target.files[0])
                                }
                                type="file"
                                accept="image/*"
                              />
                          ...
                          <div className="radio-inline-box service-perform-list">
                            <div className="checkbox sf-radio-checkbox sf-radio-check-2">
                              <input
                                required
                                onChange={(e) =>
                                  setadd_document(e.target.files[0])
                                }
                                type="file"
                                accept="image/*"
                              />
